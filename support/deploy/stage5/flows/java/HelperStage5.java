        ...
        return new Controller(){
            ...
            public synchronized void newMessage(CamelContext context) {
                ...
                if(latch == null){
                    ...
                    context.createProducerTemplate().asyncSendBody("direct:wait-until-done", null);
                }
            ...
            public void waitUntilJobDone() throws Exception {
                if(latch != null){
                    latch.await();
                }
            }

            public void jobDone() throws Exception{
                latch.countDown();
            }
