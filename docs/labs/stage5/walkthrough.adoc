...
From the admin console above we can't visualise the contents of the S3 objects created.

You can however use an online web based S3 browser to visualise the data, for example:
...
Alternatively, you can very quickly create a Camel consumer to visually confirm the data was correctly uploaded. Here's how:
