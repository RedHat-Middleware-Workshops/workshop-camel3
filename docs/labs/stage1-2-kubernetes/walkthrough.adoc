...
{empty} +
+
... To configure the `matrix.token` parameter, follow the sequence of steps shown in the image below:
+
...
{empty} +
+
... To configure the `matrix.room` parameter, follow the sequence of steps shown in the image below:
+
