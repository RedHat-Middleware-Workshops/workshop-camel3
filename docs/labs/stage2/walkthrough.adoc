...
. Deploy on OpenShift
+
Once you're happy with your local run, proceed to deploy this new version with filter on OpenShift.
+
...
+
* Use the samples below in _Matrix_ to validate your flow:
+
--
{copypaste}
----
