...
[id='lab1-part2-camel']
= Lab 1 - MessageHub - Be the Camel developer
...
As per the diagram below, the Camel developer can work at accelerated speed by editing sources and running locally.

image::images/workflow-camel-user.png[align="center", width=80%]

{empty} +

Now that you have validated your code locally, you can proceed to deploy and run in OpenShift.
