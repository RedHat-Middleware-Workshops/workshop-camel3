...
=== Join the Rocket.Chat workspace.

To accelerate the onboarding process in _Rocket.Chat_, we've deployed an instance in _OpenShift_ to freely join and use for the purpose of this enablement workshop. 
