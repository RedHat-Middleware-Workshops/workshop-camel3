...
:url-docserver: https://docserver-webapp.apps.cluster-p6cqz.dynamic.redhatworkshops.io/
...
[subs=attributes]
----
oc project {namespace}-devspaces
----
--
...
+
... Reconfigure the first proterty as follows:
+
====
* Property Name:
+
...
====
+
... Reconfigure the second proterty as follows:
+
====
* Property Name:
+
...
+
--
{copypaste}configuration/discord/user3
----
# Discord credentials
