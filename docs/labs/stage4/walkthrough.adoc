...
* link:https://discord.com/register[window="_blank"]
--
...
. Click on the link below to generate your invitation to _Discord_ (opens a new tab).
+
--
...
. In the new tab, navigate as indicated to join the workshop's server in _Discord_.
...
+
--
* link:https://discord.com/developers[window="_blank"]
+
